        ...
        <div className="">
          ...
          <form className="row">
            ...
            <div className="">
               ...
               <input className="form-control" type="text" id="phoneNumber" placeholder="Phone +233 240172381"/>
            </div>

            <div className="">
               <label htmlFor="comment" className="form-label"></label>
               <textarea className="form_control" id="comment" placeholder="  Comment" rows={3}></textarea>
            </div>
         </form>
           <div className="">
            <button 
